...
import com.vncandroid.free.databinding.ActivityVncBinding
import com.vncandroid.free.databinding.NoVideoOverlayBinding
import com.vncandroid.free.databinding.ViewerHelpBinding
import com.vncandroid.free.ui.vnc.input.InputHandler
import com.vncandroid.free.util.DeviceAuthPrompt
...
class VncActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val SAVED_STATE_KEY = "com.vncandroid.free.vnc_activity.saved_state"
    }
    ...
    override fun onStart() {
        ...
        // - It also attempts to fix some unusual cases of old updates requests being lost while VNC
    ...
    private fun startup(savedState: Bundle?) {
        ...
        runCatching {
            ...
            val isUnlockNeeded = isSavedServer && viewModel.pref.server.lockSavedServer
                                 && serverUnlockPrompt.canLaunch()

            if (isUnlockNeeded) {
                serverUnlockPrompt.init(
                        onSuccess = { startSession(startupArg) },
                        onFail = { handleStartupFailure(Exception(it)) })
    ...
    override fun onPictureInPictureModeChanged(isInPictureInPictureMode: Boolean, newConfig: Configuration) {
        ...
        if (!isInPictureInPictureMode) {
            ...
            // are still shown in Recents screen. But the app doesn't use singleTask. So VncActivity
