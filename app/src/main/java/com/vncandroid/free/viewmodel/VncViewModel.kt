        ...
        override fun onConnectionError(error: Throwable) {
            when (error) {
                ...
                is UnsatisfiedLinkError -> disconnectReason.postValue("Native library is missing! Please install correct" +
                                                                      " version of the app from F-Droid or Google Play")
            }
        }
